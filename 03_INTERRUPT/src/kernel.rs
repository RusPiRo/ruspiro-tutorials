...
//! defined with the help of the macros available in the [ruspiro-register crate](https://crates.io/ruspiro-register)
...
/// Implement the interrupt handler with a specific function attribute
/// Checkout the [ruspiro-interrupt](https://crates.io/ruspiro-interrupt) documentation
...
// [ruspiro-timer crate](https://crates.io/ruspiro-timer) in the next releases.
